            ...
            <Card className="shadow-soft">
              ...
              <CardContent>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Project Inquiry</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">I respond to all inquiries within 24 hours, usually much sooner during business hours.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Do you work with international clients?</h4>
                    <p className="text-sm text-muted-foreground">Absolutely! I've worked with clients from various time zones and am flexible with meeting schedules.</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold mb-2">What information should I include?</h4>
                    <p className="text-sm text-muted-foreground">Please share your project goals, timeline, budget range, and any specific requirements you have in mind.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Do you offer free consultations?</h4>
                    <p className="text-sm text-muted-foreground">Yes! I offer a free 30-minute consultation to discuss your project and see how I can help.</p>
                  </div>
                </div>
              </div>
            </CardContent>
